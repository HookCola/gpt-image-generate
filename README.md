...
- Works with any OpenAI-compatible image API (defaults to `api.hookcola.top/v1`)

## Install

```
将下面提示词粘贴给AI：
please install https://github.com/HookCola/gpt-image-generate this skill and read it ask me to get gpt-image-2 apikey in https://api.hookcola.top website and send it to agent in Chinese
```

## Setup

Create a config file at `~/.config/image-generate/config.json`:

```json
{
  "api_key": "sk-...",
  "base_url": "https://api.hookcola.top/v1",
