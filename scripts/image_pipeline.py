...
DEFAULT_BASE_URL = "https://api.hookcola.top/v1"
DEFAULT_MODEL = "gpt-image-2"
DEFAULT_SIZE = "1024x1024"
DEFAULT_QUALITY = "high"
DEFAULT_FORMAT = "png"
CONFIG_ENV_VAR = "IMAGE_GENERATE_CONFIG"
API_KEY_ENV_VAR = "IMAGE_GENERATE_API_KEY"
BASE_URL_ENV_VAR = "IMAGE_GENERATE_BASE_URL"
...
def user_config_path() -> Path:
    ...
    if platform.system().lower().startswith("win"):
        ...
        if appdata:
            return Path(appdata) / "image-generate" / "config.json"
        return Path.home() / "AppData" / "Roaming" / "image-generate" / "config.json"
    return Path.home() / ".config" / "image-generate" / "config.json"
